                            ...
                            <div class="table-responsive">
                                <table class="display" id="basic-1">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        $jumlah_stok = [];
                                        $stok = mysqli_query($koneksi, "SELECT * FROM bahanbaku JOIN relasi ON bahanbaku.kode_bahan = relasi.kode_bahan ORDER BY bahanbaku.kode_bahan DESC");

                                        // Menghitung Jumlah Stok Bahan Baku Masuk
                                        while ($row = mysqli_fetch_array($stok)) {
                                            if ($row['nilai'] > 0) {
                                                $jumlah_stok[$row['kode_bahan']][] = $row['nilai'];
                                            }
                                        }
