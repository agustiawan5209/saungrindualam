              ...
              <div class="col-sm-12">
                ...
                <?php
                  if (isset($_POST['mulaihitung'])) { 
                     ...
                     $hhasil = $_POST['hhasil'];
                     $tot = count($hhasil);
                     mysqli_query($koneksi, "DELETE FROM hasil_prediksi WHERE kode_bahan='$kode_bahan'");
                     for($i = 0; $i < $tot; $i++){
                        mysqli_query($koneksi, "INSERT INTO hasil_prediksi VALUES (null, '$kode_bahan', '$htanggal[$i]', '$hhasil[$i]')");
                     }
